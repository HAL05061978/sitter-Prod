...
-- Update existing 'agree' responses to have placeholder values to satisfy constraint
UPDATE public.request_responses 
SET 
    reciprocal_date = '2024-01-01',
    reciprocal_start_time = '09:00:00',
    reciprocal_end_time = '10:00:00',
    reciprocal_duration_minutes = 60,
    keep_open_to_others = false,
    initiator_agreed = false
WHERE response_type = 'agree' 
AND (reciprocal_date IS NULL OR reciprocal_start_time IS NULL OR reciprocal_end_time IS NULL);
