...
-- This script finds an available invitation and tests the trigger

-- 1. Find an invitation that hasn't been responded to by our test parent
...
-- 2. Test the trigger with the first available invitation
SELECT '=== TESTING TRIGGER WITH NEW INVITATION ===' as info;
