-- =====================================================
-- FIX PET CARE ACCEPTANCE - STORE RECIPROCAL INFO
-- =====================================================
-- ISSUE: accept_pet_care_response doesn't store reciprocal
-- date/time from the accepted response into pet_care_requests
-- =====================================================
...
BEGIN
    ...
    -- Get the care response details INCLUDING reciprocal fields
    SELECT
        cr.*,
        crr.requester_id,
        crr.group_id,
    ...
    RAISE NOTICE 'Reciprocal: % to % (%-%) pet: %',
        v_care_response.reciprocal_date,
        v_care_response.reciprocal_end_date,
    ...
    -- FIXED: Use reciprocal_end_date for multi-day reciprocal blocks
    INSERT INTO scheduled_pet_care (
        parent_id,
        group_id,
        care_date,
        ...
        v_care_response.group_id,
        v_care_response.reciprocal_date,
        v_care_response.reciprocal_end_date,  -- FIXED: Added end_date for multi-day
        v_care_response.reciprocal_start_time,
        v_care_response.reciprocal_end_time,
        'provided',
        'confirmed',
    ...
    -- Added blocks_created and notification_source fields
    ...
    SELECT
        ...
        jsonb_build_object(
            ...
            'care_type', 'pet',
            'blocks_created', 2,  -- Added blocks_created field
            'notification_source', 'pet_care'  -- Added notification_source field
        ),
        false,
        NOW();
    ...
    -- FIXED: Copy reciprocal date/time information from the accepted response
    ...
    SET
        ...
        reciprocal_date = v_care_response.reciprocal_date,
        reciprocal_end_date = v_care_response.reciprocal_end_date,
        reciprocal_start_time = v_care_response.reciprocal_start_time,
        reciprocal_end_time = v_care_response.reciprocal_end_time,
    ...
    RAISE NOTICE 'Updated pet care request with reciprocal info - date: % to %, time: %-%, pet: %',
        v_care_response.reciprocal_date,
        v_care_response.reciprocal_end_date,
        v_care_response.reciprocal_start_time,
        v_care_response.reciprocal_end_time,
