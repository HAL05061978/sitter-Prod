-- =====================================================
-- FIX SCHEDULED_CARE CHILD_ID FOR HANGOUT/SLEEPOVER
-- =====================================================
-- For hangout/sleepover blocks, multiple children are involved
-- and tracked in scheduled_care_children, so child_id should be nullable

-- =====================================================
-- STEP 1: Make child_id nullable in scheduled_care
-- =====================================================
...
COMMENT ON COLUMN scheduled_care.child_id IS
'Child ID for single-child care blocks. NULL for multi-child blocks (hangout, sleepover) where children are tracked in scheduled_care_children';

-- =====================================================
-- STEP 2: Update create_hangout_invitation function
-- =====================================================
...
-- =====================================================
-- STEP 3: Update create_sleepover_invitation function
-- =====================================================
...
COMMENT ON FUNCTION create_hangout_invitation IS 'Creates a hangout invitation with multiple hosting and invited children. Sets child_id to NULL in both care_requests and scheduled_care since children are tracked in scheduled_care_children and care_responses.';
COMMENT ON FUNCTION create_sleepover_invitation IS 'Creates a sleepover invitation with multiple hosting and invited children. Sets child_id to NULL in both care_requests and scheduled_care since children are tracked in scheduled_care_children and care_responses.';
