-- =====================================================
-- DEPLOY STEP 1: Fix get_my_submitted_responses
-- =====================================================
-- This fixes messages not appearing when responses are accepted/declined
-- SAFE: This is read-only, only affects what messages display in inbox
--
-- INSTRUCTIONS:
...
BEGIN
    ...
    AND cr.status IN ('submitted', 'pending', 'accepted', 'declined')  -- THE KEY FIX: Show all statuses
