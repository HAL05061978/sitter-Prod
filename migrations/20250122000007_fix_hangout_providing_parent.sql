-- =====================================================
-- FIX HANGOUT/SLEEPOVER PROVIDING_PARENT_ID
-- =====================================================
-- The scheduled_care_children table requires providing_parent_id
-- For hangout/sleepover invitations, this is the hosting parent
...
COMMENT ON FUNCTION create_hangout_invitation IS 'Creates a hangout invitation with multiple hosting and invited children. The hosting parent is set as providing_parent_id for all hosting children.';
COMMENT ON FUNCTION create_sleepover_invitation IS 'Creates a sleepover invitation with multiple hosting and invited children. The hosting parent is set as providing_parent_id for all hosting children.';
