-- =====================================================
-- HANGOUT/SLEEPOVER ACCEPT AND DECLINE FUNCTIONS
-- =====================================================
...
DO $$
BEGIN
    -- Drop all overloaded versions of accept_hangout_sleepover_invitation
    EXECUTE (
        SELECT string_agg('DROP FUNCTION IF EXISTS ' || oid::regprocedure || ';', ' ')
        FROM pg_proc
        WHERE proname = 'accept_hangout_sleepover_invitation'
    );

    -- Drop all overloaded versions of decline_hangout_sleepover_invitation
    EXECUTE (
        SELECT string_agg('DROP FUNCTION IF EXISTS ' || oid::regprocedure || ';', ' ')
        FROM pg_proc
        WHERE proname = 'decline_hangout_sleepover_invitation'
    );
EXCEPTION
    WHEN OTHERS THEN
...
-- =====================================================
-- Function to accept a hangout/sleepover invitation
-- =====================================================
...
-- =====================================================
-- Function to decline a hangout/sleepover invitation
-- =====================================================
...
COMMENT ON FUNCTION accept_hangout_sleepover_invitation IS 'Accepts a hangout or sleepover invitation, creating a receiving care block for the invited child';
COMMENT ON FUNCTION decline_hangout_sleepover_invitation IS 'Declines a hangout or sleepover invitation with optional reason';
