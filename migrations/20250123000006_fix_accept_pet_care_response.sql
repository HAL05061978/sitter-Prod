-- =====================================================
-- FIX ACCEPT PET CARE RESPONSE FUNCTION
-- =====================================================
-- Update to match child care workflow:
-- 1. Decline other responses first (before updating request)
-- 2. Send notifications to responders
-- 3. Properly update request status at the end
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '✅ Now handles status correctly (submitted -> accepted)';
    RAISE NOTICE '✅ Declines other responses before updating request';
    RAISE NOTICE '✅ Sends notifications to all responders';
END $$;
