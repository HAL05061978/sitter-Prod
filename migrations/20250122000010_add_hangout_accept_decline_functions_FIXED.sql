...
DROP FUNCTION IF EXISTS decline_hangout_sleepover_invitation(UUID, UUID);

-- =====================================================
-- Function to accept a hangout/sleepover invitation
-- =====================================================

CREATE FUNCTION accept_hangout_sleepover_invitation(
...
CREATE FUNCTION decline_hangout_sleepover_invitation(
    p_care_response_id UUID,
