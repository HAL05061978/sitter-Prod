-- =====================================================
-- ADD IS_HOST FIELD TO CALENDAR FUNCTION
-- =====================================================
-- Add is_host boolean to distinguish hosting vs attending
-- without relying on notes field
...
COMMENT ON FUNCTION get_scheduled_care_for_calendar IS 'Returns scheduled care blocks for calendar with is_host field to distinguish hosting vs attending without relying on notes.';
