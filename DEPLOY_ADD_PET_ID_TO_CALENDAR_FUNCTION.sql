-- Add pet_id field to get_scheduled_pet_care_for_calendar function
-- This allows the frontend to distinguish pet care blocks from child care blocks
...
RETURNS TABLE (
    ...
    children_data JSONB,
    is_host BOOLEAN,
    pet_id UUID  -- NEW: Added to identify pet care blocks
)
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
