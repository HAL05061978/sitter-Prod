...
export default function Header({ currentPage = "dashboard" }: HeaderProps) {
  ...
  const fetchNewCalendarBlocksCount = async (userId: string) => {
    ...
    try {
      ...
      setNewCalendarBlocksCount(notificationBlocks);
      localStorage.setItem('newCalendarBlocksCount', notificationBlocks.toString());
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 bg-white shadow-soft border-b border-gray-200 z-40">
