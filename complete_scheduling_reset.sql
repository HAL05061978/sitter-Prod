-- Complete Scheduling Reset
-- This script completely resets the scheduling system and recreates everything properly
...
SELECT 'Complete scheduling reset successful! You can now test the Parent A ↔ Parent B workflow from scratch.' as status; 