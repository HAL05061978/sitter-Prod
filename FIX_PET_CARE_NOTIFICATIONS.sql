-- =====================================================
-- FIX PET CARE NOTIFICATIONS
-- =====================================================
-- Add blocks_created field to pet care acceptance notifications
-- so they appear in the calendar counter
-- =====================================================
...
BEGIN
    ...
    -- FIXED: Send notification to the responder whose response was accepted
    ...
    SELECT
        ...
        jsonb_build_object(
            ...
            'care_type', 'pet',
            'blocks_created', 2,  -- FIXED: Added blocks_created field
            'notification_source', 'pet_care'  -- FIXED: Added notification_source field
        ),
        false,
        NOW();
