-- FIX DURATION MINUTES REMOVAL
-- Remove all references to duration_minutes column from create_open_block_invitation function
...
DO $$
BEGIN
    RAISE NOTICE '=== FIXED DURATION MINUTES REMOVAL ===';
    RAISE NOTICE '1. Removed all references to duration_minutes column';
    RAISE NOTICE '2. Updated SELECT statement to exclude duration_minutes';
    RAISE NOTICE '3. Updated INSERT statement to exclude duration_minutes';
    RAISE NOTICE '4. Function should now work without the removed column';
