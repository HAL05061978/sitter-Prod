#!/usr/bin/env python3
"""
Extract all functions from AllFunctions.csv and create SQL script
"""
...
def extract_functions():
    """Extract all functions from AllFunctions.csv"""
            ...
            for row in reader:
                ...
                if routine_name and routine_name.strip():
                    ...
                    current_function = {
                        ...
                        'return_type': data_type.strip() if data_type else 'void',
                        'specific_name': specific_name.strip() if specific_name else '',
                        'definition': ''
                    }
                    current_definition = []
                ...
                if routine_definition and routine_definition.strip():
                    current_definition.append(routine_definition.strip())
...
"""
    ...
    for func in functions:
        if func['definition']:
            ...
            definition = func['definition'].strip()
