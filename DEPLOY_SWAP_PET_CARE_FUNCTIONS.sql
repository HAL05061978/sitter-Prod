-- Swap the pet care functions to match child care logic
-- Currently they are backwards!

-- =====================================================
-- Fix 1: get_reciprocal_pet_care_requests
-- Should return: Requests I MADE (where I'm requester)
-- Currently returns: Invitations where I'm responder (WRONG!)
-- =====================================================
...
BEGIN
    ...
    WHERE pcrq.requester_id = p_parent_id  -- SWAPPED: Now returns MY requests
    AND pcr.status IN ('submitted', 'accepted', 'declined')  -- Only show submitted/accepted/declined, NOT pending
...
-- Should return: Invitations I RECEIVED (where I'm responder)
-- Currently returns: Responses to MY requests (WRONG!)
-- =====================================================
...
BEGIN
    ...
    WHERE pcr.responder_id = p_parent_id  -- SWAPPED: Now returns invitations where I'm responder
