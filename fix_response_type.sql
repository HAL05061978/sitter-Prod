-- FIX RESPONSE TYPE IN CREATE OPEN BLOCK INVITATION
-- Change response_type from 'open_block_invitation' to 'pending' to match database constraints
...
DO $$
BEGIN
    RAISE NOTICE '=== FIXED RESPONSE TYPE ===';
    RAISE NOTICE '1. Changed response_type from open_block_invitation to pending';
    RAISE NOTICE '2. This matches the database constraint for care_responses table';
    RAISE NOTICE '3. Function should now work without constraint violation';
