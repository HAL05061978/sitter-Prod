-- Fix Open Block Trigger with Comprehensive Debugging
-- This script creates a robust trigger function that handles open block acceptance
...
-- Success message
SELECT 'Open block trigger fixed and created successfully!' as status;
